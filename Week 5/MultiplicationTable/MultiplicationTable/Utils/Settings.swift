...
enum NumOfQuestions: String, CaseIterable {
    case five = "5"
    case ten = "10"
    case twenty = "20"
    case all = "All"
...
class Settings: ObservableObject {
    ...
    var numberOfQuestions = NumOfQuestions.allCases
    
    var numOfQuestion: Int {
        if let number = Int(numberOfQuestions[numberOfQuestionsIndex].rawValue) {
            return number
        }
